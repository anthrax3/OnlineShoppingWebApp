...
namespace OnlineShoppingWebApp
{
    public partial class MasterPage : System.Web.UI.MasterPage
    {
        ...
        //        {
        //            Label ProductName = item.FindControl("lblProductName") as Label;
        //            //   TextBox ProductName = item.FindControl("txtProductName") as TextBox;
        ...
        //{
        //    rfvCustomerName.Validate();
        //    rfvCustomerEmailID.Validate();
        //    rfvCustomerAddress.Validate();
        //    rfvCustomerPhoneNo.Validate();
        ...
        //                //   TotalPrice =Convert.ToInt32(dtResult.Rows[0]["@TotalPrice"])
        //            };
        ...
        private void SendOrderPlaceAlert(String CustomerName, String CustomerEmailID, string TransactionNo)
        {
            ...
            EmailEngine.SendEmail(CustomerEmailID, "Online Shopping : Your OrderDetails", body);
        }
        ...
        private string PopulateOrderEmailBody(string customerName, string transactionNo)
        {
            ...
            body = body.Replace("{TransactionURL}", "http://www.OnlineShopping.tk/TrackYourOrder.aspx?ID=" + transactionNo);
        ...
        //        //        ProductID = Convert.ToInt32(dt.Rows[i]["ProductID"]),
        //        //        TotalProducts = Convert.ToInt32(dt.Rows[i]["ProductQuantity"])
        //        //        //   TotalPrice = Convert.ToInt32(dtResult.Rows[i]["TotalPrice"])
        //        //    };
        ...
        //         foreach (Order myorder1 in orderList)
        //         {
        //             myOrder.Add(myorder1);
        //         }*/

        //        //Session.Clear();
        //        //GetMyCart();

        //        //List<Order1> myOrder = new List<Order1>();

        //        //    foreach (DataRow row in dtResult.Rows)
        //        //    {
        //        ////    myOrder.Add(new string[] { row.ToString()});
        //        //    }
        ...
        //        if (Session["TotalPrice"] != null)// if (Session["Payment_amt"] != null)
        //        {
        //            string amt = Session["TotalPrice"].ToString();// string amt = Session["Payment_amt"].ToString();

        //            bool ret = nvpapicaller.ShortcutExpressCheckout(amt, ref token, ref retMsg, dt);
        //            //   bool ret = nvpapicaller.ShortcutExpressCheckout(amt, ref token, ref retMsg, myOrder);
        ...
        protected void btnSearchProduct_Click(object sender, EventArgs e)
        {
            if (txtSearch.Text != "")
            {
                string ProductName = Convert.ToString(txtSearch.Text);
